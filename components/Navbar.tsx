...
import { 
  Menu, X, ShoppingBag, Search, Wrench,
      ...
      <div className="container mx-auto px-6 h-full flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3.5 group select-none shrink-0" onClick={() => setMenuAcik(false)}>
          ...
          <div className="relative w-11 h-11 flex items-center justify-center">
             ...
             {/* SVG ÇİZİMİ: ENTEGRE DEVRE FORMU */}
             <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-lg relative z-10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  ...
                  {/* Merkezdeki parlak nokta için radyal gradyan */}
                ...
                {/* Merkez Çekirdek (İşlemci) */}
                <rect 
                  x="36" y="36" width="28" height="28" rx="3" 
                  transform="rotate(45 50 50)" 
                  fill="url(#coreGradient)"
                  className="group-hover:scale-105 transition-transform duration-300 origin-center outline outline-1 outline-white/20"
                />
                
                {/* Merkez Enerji Noktası (Nabız) - YENİ */}
                <circle cx="50" cy="50" r="5" fill="url(#centerGlow)" className="animate-pulse-slow" />

                {/* Devre Yolları / Veri Akışı (İnce Detaylar) - GÜNCELLENDİ */}
                {/* Üstteki yollar */}
